...
async def lifespan(app: FastAPI):
    ...
    """
    # Código de Startup
    print("INFO:     Iniciando o serviço de Produtos...")
    ...
    print("INFO:     Desligando o serviço de Produtos...")
...
# Incluir o roteador das rotas de produtos
# (O arquivo 'routes/products.py' será nosso próximo passo)
